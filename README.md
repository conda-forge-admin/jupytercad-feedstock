...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupytercad-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupytercad-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupytercad jupytercad-app jupytercad-core jupytercad-lab jupytercad-lite
# for installing globally
pixi global install jupytercad jupytercad-app jupytercad-core jupytercad-lab jupytercad-lite
```
...
It is possible to list all of the versions of `jupytercad` available on your platform:
...
```
pixi search jupytercad --channel conda-forge
```
